...
int main()
{
	...
	/*
		...
		poly1[9] = poly1[1];
	*/
		poly1[0] = r3 * cos((angle + 135) / 57.3) + a - 2*unit;
		poly1[1] = r3 * sin((angle + 135) / 57.3) + b - 2*unit;

		poly1[2] = r4 * cos((angle + 90) / 57.3) + a - 2*unit;
		poly1[3] = r4 * sin((angle + 90) / 57.3) + b - 2*unit;

		poly1[4] = 0 + a - 2*unit;
		poly1[5] = 0 + b - 2*unit;

		poly1[6] = r4 * cos((angle + 180) / 57.3) + a - 2*unit;
		poly1[7] = r4 * sin((angle + 180) / 57.3)+ b - 2*unit;
